...
values (1, 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil', 0, utc_timestamp, 298.90, 10, 308.90);
...
insert into pedido (id, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
            endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
            status, data_criacao, subtotal, taxa_frete, valor_total) values (2, 4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro', 0, utc_timestamp, 79, 0, 79);
